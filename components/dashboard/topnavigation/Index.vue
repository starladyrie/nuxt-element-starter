<template>
  <header
    class="bg-white h-16 items-center relative shadow w-full z-10 md:h-20 lg:rounded-2xl"
  >
    <div
      ...
      >
        <div class="flex h-full left-0 relative w-3/4">
          ...
          <div class="flex group h-full items-center relative w-36 lg:w-64">
            ...
            <input
              type="text"
              class="bg-gray-100 block leading-normal pl-10 py-1.5 pr-4 ring-opacity-90 rounded-2xl text-gray-400 w-full focus:border-transparent focus:outline-none focus:ring-2 focus:ring-[#FECC00]"
              placeholder="Search"
            />
            <div
        ...
        <div
          class="flex items-center justify-end ml-5 p-1 relative w-1/4 sm:mr-0 sm:right-auto"
        >
          <el-dropdown
